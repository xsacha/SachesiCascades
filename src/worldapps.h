...
public:
    ...
    bb::cascades::DataModel* screenshots() const {
        return new bb::cascades::QListDataModel<QString>(_screenshots);
    }
    ...
    void screenshotsDidChange() { emit screenshotsChanged(); }
...
Q_DECLARE_METATYPE(AppWorldApps* );
